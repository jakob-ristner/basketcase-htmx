...
With templ installed and the binary somewhere on your PATH, run the following to generate your HTML shareds and templates (remove --watch to simply build and not hot reload)
...
This function enables you to tack on middleware at the end of a handler instead of having to deeply-nest middleware shareds (which is what you would usually expect).
...
Our templates are included in this file. Here is the Base template discussed in the previous section. This function simply takes in a title and an array of templ.shared. For more info on templ syntax, please visit [Templ.guide](templ.guide)
...
### shareds - ./internal/shared/shared.templ

Comonents are very similar to templates. Here is an example of the TextAndTitle shared used in ./internal/view/view.go
